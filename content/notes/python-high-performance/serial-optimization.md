...
{{% code-download file="/notes/python-high-performance/codes/replace_forloop_comp.py" lang="python" %}}
...
{{% code-download file="/notes/python-high-performance/codes/loops.py" lang="python" %}}

Eliminating for loops is **much faster** (`aops.py`)
{{% code-download file="/notes/python-high-performance/codes/aops.py" lang="python" %}}
...
{{% code-download file="/notes/python-high-performance/codes/replace_forloop.py" lang="python" %}}
