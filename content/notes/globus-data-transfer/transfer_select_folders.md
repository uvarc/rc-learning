...
{{< figure src="/notes/globus-data-transfer/imgs/globus_select_folder.png" caption="Select files or folders to transfer" width=50% alt="The Globus File Manager page, with a file picker for 'eubanks desktop' in the left pane.">}}
