...
{{< figure src="/notes/hpc-intro/img/OOD_files_tab.png" caption="OOD Files Menu" alt="The UVA OpenOnDemand menu bar with 'Home Directory' in the Files dropdown selected. This opens a webpage with a row of buttons for file actions, checkboxes for showing owner/mode and dotfiles, a filter box, and a list of directories and files." >}}
