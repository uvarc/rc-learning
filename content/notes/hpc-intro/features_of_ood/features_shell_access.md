...
{{< figure src="/notes/hpc-intro/img/features_shell_access.png" caption="Command line Shell Access" alt="The Open OnDemand menu bar, with the Clusters dropdown opened and HPC Shell Access selected." >}}
