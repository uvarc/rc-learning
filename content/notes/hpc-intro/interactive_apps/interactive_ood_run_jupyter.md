...
{{< figure src="/notes/hpc-intro/img/OOD_Jupyter_nb.png" caption="Starting a new notebook." alt="The File > New menu in JupyterLab, with options for new console, notebook, terminal, text file, and Markdown file." >}}
...
{{< figure src="/notes/hpc-intro/img/OOD_delete_session.png" caption="Ending a session." alt="The Open OnDemand info box for an active JupyterLab session, with a Delete button." >}}
