...
{{< figure src="/notes/hpc-intro/img/OOD_Jupyter_connect.png" caption="Connecting to a session." alt="The My Interactive Sessions page, where a JupyterLab session is shown as running, with a 'Connect to Jupyter' button." >}}
...
{{< figure src="/notes/hpc-intro/img/OOD_Jupyter_kernels.png" caption="Start screen for JupyterLab" alt="The JupyterLab start screen, showing various kernel options as tiles, and a sidebar on the left with files." >}}
