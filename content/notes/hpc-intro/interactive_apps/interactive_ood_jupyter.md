...
{{< figure src="/notes/hpc-intro/img/Interactive-Jupyter-form-2026.png" caption="Setting up a job in JupyterLab through OOD" alt="A form with various parameters for launching a JupyterLab interactive session through OOD." >}}
