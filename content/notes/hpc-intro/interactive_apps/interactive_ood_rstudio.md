...
{{< figure src="/notes/hpc-intro/img/Interactive-RStudio-form-2026.png" caption="Starting an Rstudio session." alt="A form with various parameters for launching an RStudio Server interactive session.">}}
