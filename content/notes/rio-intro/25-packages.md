...
* Since /home is not mounted on compute nodes, locally installed Python and R packages must be staged on /standard instead.
  * Both languages, by default, install to a folder in /home. Configuration changes are necessary to use Python and R in your compute jobs on Rio.
