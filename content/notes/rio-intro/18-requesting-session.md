...
{{< figure src=/notes/rio-intro/img/jupyterlab.png alt="Open OnDemand JupyterLab launch form showing fields: Partition set to Standard, 1 hour, 1 core, 6 GB memory, allocation hpc_build, and a Launch button." width=90% height=90% >}}
