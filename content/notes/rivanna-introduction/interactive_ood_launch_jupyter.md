...
{{< figure src="/notes/rivanna-introduction/img/OOD_Jupyter_connect.png" caption="Connecting to a session." >}}
...
{{< figure src="/notes/rivanna-introduction/img/OOD_Jupyter_kernels.png" caption="Start screen for JupyterLab" >}}
