...
{{< figure src="/notes/rivanna-introduction/img/OOD_Jupyter_nb.png" caption="Starting a new noteboook." >}}
...
{{< figure src="/notes/rivanna-introduction/img/OOD_delete_session.png" caption="Ending a session." >}}
