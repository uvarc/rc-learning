...
{{< code-download file="/courses/python_introduction/scripts/pandas_plot.py" lang="python" >}}
...
{{< code-download file="/courses/python_introduction/scripts/multiplot.py" lang="python" >}}

Bar charts are similarly simple to create, with nice default labeling.

{{< code-download file="/courses/python_introduction/scripts/barchart.py" lang="python" >}}
...
{{< code-download file="/courses/python_introduction/scripts/plot_table.py" lang="python" >}}
