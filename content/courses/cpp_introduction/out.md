...
* Also install MSYS for a minimalist Unix system.
  ...
  * After the installation, follow instructions for "After Installing" at[http://www.mingw.org/wiki/Getting_Started](http://www.mingw.org/wiki/Getting_Started)
...
One of its containers is themulti_array
...
typedefboost::multi_array<double, 2> Array2D;
...
voidset_privatevar(double value);

doubleget_privatevar();
...
voidMyClass::set_privatevar(double value) {privatevar=value;}

doubleMyClass::get_privatevar(){returnprivatevar;}
