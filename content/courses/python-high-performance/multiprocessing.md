...
{{< figure src="/courses/python-high-performance/mp-scaling.png" caption="Scaling performance for the Multiprocessing Monte Carlo Pi example." alt="Graph of time to solution versus number of cores, showing good speedup for Multiprocessing in the Monte Carlo Pi example" >}}
