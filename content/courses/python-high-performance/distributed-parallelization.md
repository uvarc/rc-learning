...
{{< figure src="/courses/python-high-performance/SMP.png" caption="Schematic of an SMP system" alt="Schematic drawing of an SMP system showing shared memory layout" >}}
...
{{< figure src="/courses/python-high-performance/DMP.png" caption="Schematic of a DMP system" alt="Schematic drawing of a distributed-memory system showing nodes with an interconnection" >}}
...
<figure>
<img src="/courses/python-high-performance/codes/da_mean.png" alt="Graph of the expected result from running the dask example script" width=720 />
</figure>
</details>
{{< /rawhtml >}}
