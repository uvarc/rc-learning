...
{{< figure src="/tutorials/hpc-intro/img/OOD_Jupyter_connect.png" caption="Connecting to a session." >}}
...
{{< figure src="/tutorials/hpc-intro/img/OOD_Jupyter_kernels.png" caption="Start screen for JupyterLab" >}}
